...
Usage:
    $ python path/to/train.py --datasets coco128.yaml --weights yolov5s.pt --img 640
"""
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    init_seeds(1 + RANK)
    with open(data) as f:
        data_dict = yaml.safe_load(f)  # datasets dict
...
def parse_opt(known=False):
    ...
    parser.add_argument('--datasets', type=str, default='datasets/coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='datasets/hyps/hyp.scratch.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--single-cls', action='store_true', help='train multi-class datasets as single-class')
