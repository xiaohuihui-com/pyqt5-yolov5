...
Usage:
    $ python path/to/val.py --datasets coco128.yaml --weights yolov5s.pt --img 640
"""
...
def main(opt):
    ...
    if opt.task in ('train', 'val', 'test'):  # run normally
        ...
        # python val.py --task study --datasets coco.yaml --iou 0.7 --weights yolov5s.pt yolov5m.pt yolov5l.pt yolov5x.pt
